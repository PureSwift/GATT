...
public struct LinuxAdvertisementData: AdvertisementData {
...
extension LinuxAdvertisementData: Equatable {
    
    public static func == (lhs: LinuxAdvertisementData, rhs: LinuxAdvertisementData) -> Bool {
...
public extension LinuxAdvertisementData {
